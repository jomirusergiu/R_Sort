...
- Bubble sort is a sorting algorithm that continuously steps through a list, swapping items until they appear in the correct order.
...
Other sorts
--------------------------------
There are also some other sorts that don't really fit in categories above, some examples are listed below.
